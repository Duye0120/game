                      ...
                      {Object.entries(bestRecords)
                          ...
                          .map(([key, record]) => {
                            ...
                            return (
                              <div
                                key={key}
                                className={`p-3 rounded-lg border transition-all ${key === getRecordKey(gameConfig.gridSize, gameConfig.difficulty)
                                ...
                                <div className="flex justify-between items-start mb-2">
                                  <div className="flex gap-2">
                                    <Badge variant="outline" className="text-xs">
                                      {getGridSizeName(Number.parseInt(gridSize) as GridSize)}
                                    </Badge>
